...
### Ulucoin maintainers/release engineers, suggestion for writing release notes
>>>>>>> dev
...
=======
    ./bin/gbuild -i --commit signature=v${VERSION} ../ulucoin/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs.ltc/ ../ulucoin/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-win-signed ../ulucoin/contrib/gitian-descriptors/gitian-win-signer.yml
    mv build/out/ulucoin-*win64-setup.exe ../ulucoin-${VERSION}-win64-setup.exe
    mv build/out/ulucoin-*win32-setup.exe ../ulucoin-${VERSION}-win32-setup.exe
>>>>>>> dev
    popd
...
=======
ulucoin-${VERSION}-aarch64-linux-gnu.tar.gz
ulucoin-${VERSION}-arm-linux-gnueabihf.tar.gz
ulucoin-${VERSION}-i686-pc-linux-gnu.tar.gz
ulucoin-${VERSION}-x86_64-linux-gnu.tar.gz
ulucoin-${VERSION}-osx64.tar.gz
ulucoin-${VERSION}-osx.dmg
ulucoin-${VERSION}.tar.gz
ulucoin-${VERSION}-win32-setup.exe
ulucoin-${VERSION}-win32.zip
ulucoin-${VERSION}-win64-setup.exe
ulucoin-${VERSION}-win64.zip
>>>>>>> dev
```
