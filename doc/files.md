...
=======
* ulucoin.conf: contains configuration settings for ulucoind or ulucoin-qt
* ulucoind.pid: stores the process id of ulucoind while running
>>>>>>> dev
...
=======
* debug.log: contains debug information and general logging generated by ulucoind or ulucoin-qt
>>>>>>> dev
