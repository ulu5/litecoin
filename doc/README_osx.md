...
=======
  using the script that is also included there. Detached signatures are available from this [repository](https://github.com/ulucoin-project/ulucoin-detached-sigs).
>>>>>>> dev
