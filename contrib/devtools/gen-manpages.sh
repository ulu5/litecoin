...
=======
BITCOIND=${BITCOIND:-$SRCDIR/ulucoind}
BITCOINCLI=${BITCOINCLI:-$SRCDIR/ulucoin-cli}
BITCOINTX=${BITCOINTX:-$SRCDIR/ulucoin-tx}
BITCOINQT=${BITCOINQT:-$SRCDIR/qt/ulucoin-qt}
>>>>>>> dev
