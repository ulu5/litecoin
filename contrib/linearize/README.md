...
=======
Construct a linear, no-fork, best version of the Ulucoin blockchain. The scripts
>>>>>>> dev
...
=======
JSON-RPC server. Running `ulucoind` or `ulucoin-qt -server` will be sufficient.
>>>>>>> dev
...
=======
* `input`: ulucoind blocks/ directory containing blkNNNNN.dat
>>>>>>> dev
