...
=======
            "importprivkey \"ulucoinprivkey\" ( \"label\" ) ( rescan )\n"
            "\nAdds a private key (as returned by dumpprivkey) to your wallet.\n"
            "\nArguments:\n"
            "1. \"ulucoinprivkey\"   (string, required) The private key (see dumpprivkey)\n"
>>>>>>> dev
...
=======
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Ulucoin address or script");
>>>>>>> dev
    }
...
=======
            "1. \"address\"   (string, required) The ulucoin address for the private key\n"
>>>>>>> dev
            "\nResult:\n"
...
=======
            "1. \"filename\"    (string, required) The filename with path (either absolute or relative to ulucoind)\n"
>>>>>>> dev
            "\nResult:\n"
            "{                           (json object)\n"
...
=======
    file << strprintf("# Wallet dump created by Ulucoin %s\n", CLIENT_BUILD);
>>>>>>> dev
