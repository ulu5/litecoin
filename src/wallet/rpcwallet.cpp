...
=======
            "\nReturns a new Ulucoin address for receiving payments.\n"
>>>>>>> dev
...
=======
            "\"address\"    (string) The new ulucoin address\n"
>>>>>>> dev
            "\nExamples:\n"
...
=======
            "\nDEPRECATED. Returns the current Ulucoin address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"address\"          (string) The account ulucoin address\n"
>>>>>>> dev
            "\nExamples:\n"
...
=======
            "\nReturns a new Ulucoin address, for receiving change.\n"
>>>>>>> dev
...
=======
            "1. \"address\"         (string, required) The ulucoin address to be associated with an account.\n"
>>>>>>> dev
...
=======
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Ulucoin address");
>>>>>>> dev
...
=======
            "1. \"address\"         (string, required) The ulucoin address for account lookup.\n"
>>>>>>> dev
            "\nResult:\n"
...
=======
            "  \"address\"         (string) a ulucoin address associated with the given account\n"
>>>>>>> dev
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
=======
            "1. \"address\"            (string, required) The ulucoin address to send to.\n"
>>>>>>> dev
...
=======
            "                             The recipient will receive less ulucoins than you enter in the amount field.\n"
>>>>>>> dev
...
=======
            "      \"address\",            (string) The ulucoin address\n"
>>>>>>> dev
...
=======
            "1. \"address\"         (string, required) The ulucoin address to use for the private key.\n"
>>>>>>> dev
...
=======
            "1. \"address\"         (string, required) The ulucoin address for transactions.\n"
>>>>>>> dev
...
=======
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a ulucoin address."
>>>>>>> dev
            + HelpRequiringPassphrase(pwallet) + "\n"
            "\nArguments:\n"
...
=======
            "2. \"toaddress\"         (string, required) The ulucoin address to send funds to.\n"
>>>>>>> dev
...
=======
            "      \"address\":amount   (numeric or string) The ulucoin address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
>>>>>>> dev
            "      ,...\n"
            "    }\n"
...
=======
            "                           Those recipients will receive less ulucoins than you enter in their corresponding amount field.\n"
>>>>>>> dev
...
=======
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Ulucoin address: ")+name_);
>>>>>>> dev
...
=======
            "Each key is a Ulucoin address or hex-encoded public key.\n"
>>>>>>> dev
...
=======
            "2. \"keys\"         (string, required) A json array of ulucoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) ulucoin address or hex-encoded public key\n"
>>>>>>> dev
            "       ...,\n"
            "     ]\n"
...
=======
            "\"address\"         (string) A ulucoin address associated with the keys.\n"
>>>>>>> dev
...
=======
            "    \"address\":\"address\",    (string) The ulucoin address of the transaction. Not present for \n"
>>>>>>> dev
...
=======
            "    \"address\":\"address\",    (string) The ulucoin address of the transaction. Not present for move transactions (category = move).\n"
>>>>>>> dev
...
=======
            "      \"address\" : \"address\",          (string) The ulucoin address involved in the transaction\n"
>>>>>>> dev
...
=======
            "This is needed prior to performing transactions related to private keys such as sending ulucoins\n"
>>>>>>> dev
            "\nArguments:\n"
...
=======
            "\nNow set the passphrase to use the wallet, such as for signing or sending ulucoin\n"
>>>>>>> dev
...
=======
    return "wallet encrypted; Ulucoin server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
>>>>>>> dev
}
...
=======
            "A locked transaction output will not be chosen by automatic coin selection, when spending ulucoins.\n"
>>>>>>> dev
...
=======
            "3. \"addresses\"      (string) A json array of ulucoin addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) ulucoin address\n"
>>>>>>> dev
            "      ,...\n"
            "    ]\n"
...
=======
            "    \"address\" : \"address\",    (string) the ulucoin address\n"
>>>>>>> dev
...
=======
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Ulucoin address: ")+input.get_str());
>>>>>>> dev
            if (setAddress.count(address))
...
=======
                            "     \"changeAddress\"          (string, optional, default pool address) The ulucoin address to receive the change\n"
>>>>>>> dev
...
=======
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "changeAddress must be a valid ulucoin address");
>>>>>>> dev
