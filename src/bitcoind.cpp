...
=======
                  "  ulucoind [options]                     " + strprintf(_("Start %s Daemon"), _(PACKAGE_NAME)) + "\n";
>>>>>>> dev
...
=======
                fprintf(stderr, "Error: Command line contains unexpected token '%s', see ulucoind -h for a list of options.\n", argv[i]);
>>>>>>> dev
                exit(EXIT_FAILURE);
            }
        }
...
=======
            fprintf(stdout, "Ulucoin server starting\n");
>>>>>>> dev
