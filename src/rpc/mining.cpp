...
=======
            "2. address      (string, required) The address to send the newly generated ulucoin to.\n"
>>>>>>> dev
...
=======
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Ulucoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Ulucoin is downloading blocks...");
>>>>>>> dev
...
=======
            "  \"feerate\" : x.x,     (numeric, optional) estimate fee-per-kilobyte (in ULU)\n"
>>>>>>> dev
