...
=======
            "  \"balance\": xxxxxxx,         (numeric) the total ulucoin balance of the wallet\n"
>>>>>>> dev
...
=======
            "\nReturn information about the given ulucoin address.\n"
            "\nArguments:\n"
            "1. \"address\"     (string, required) The ulucoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The ulucoin address validated\n"
>>>>>>> dev
...
=======
            "2. \"keys\"       (string, required) A json array of keys which are ulucoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) ulucoin address or hex-encoded public key\n"
>>>>>>> dev
            "       ,...\n"
            "     ]\n"
...
=======
            "1. \"address\"         (string, required) The ulucoin address to use for the signature.\n"
>>>>>>> dev
...
=======
            "ulucoin-cli and the GUI. There is no server-side difference."
>>>>>>> dev
        );
