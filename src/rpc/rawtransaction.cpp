...
=======
            "      \"address\": x.xxx,    (numeric or string, required) The key is the ulucoin address, the numeric value (can be string) is the " + CURRENCY_UNIT + " amount\n"
>>>>>>> dev
...
=======
            "           \"12tvKAXCxZjSmdNbao16dKXC8tRWfcF5oc\"   (string) ulucoin address\n"
>>>>>>> dev
            "           ,...\n"
            "         ]\n"
            "       }\n"
