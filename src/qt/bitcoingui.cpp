...
=======
    sendCoinsAction->setStatusTip(tr("Send coins to a Ulucoin address"));
>>>>>>> dev
...
=======
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ulucoin: URIs)"));
>>>>>>> dev
...
=======
    signMessageAction->setStatusTip(tr("Sign messages with your Ulucoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ulucoin addresses"));
>>>>>>> dev
...
=======
    openAction->setStatusTip(tr("Open a ulucoin: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Ulucoin command-line options").arg(tr(PACKAGE_NAME)));
>>>>>>> dev
...
=======
        tooltip = tr("%n active connection(s) to Ulucoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
>>>>>>> dev
    } else {
...
=======
    QString strTitle = tr("Ulucoin"); // default title
>>>>>>> dev
