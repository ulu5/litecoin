...
=======
const QString BITCOIN_IPC_PREFIX("ulucoin:");
>>>>>>> dev
...
=======
const char* BIP71_MIMETYPE_PAYMENT = "application/ulucoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ulucoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ulucoin-paymentrequest";
>>>>>>> dev
...
=======
                tr("Cannot start ulucoin: click-to-pay handler"));
>>>>>>> dev
        }
        else {
...
=======
                    tr("URI cannot be parsed! This can be caused by an invalid Ulucoin address or malformed URI parameters."),
>>>>>>> dev
                    CClientUIInterface::ICON_WARNING);
